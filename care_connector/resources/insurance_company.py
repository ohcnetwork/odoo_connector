        ...
        try:
            ...
            if insurance_company:
                insurance_company_list.append({
                    ...
                    "account_id": insurance_company.account_id.id if insurance_company.account_id else None,
                    "account_name": insurance_company.account_id.name if insurance_company.account_id else None,
        ...
        try:
            ...
            for company in insurance_companies:
                insurance_company_list.append({
                    ...
                    "account_id": company.account_id.id if company.account_id else None,
                    "account_name": company.account_id.name if company.account_id else None,
