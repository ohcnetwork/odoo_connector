...
class SalesRegisterWizard(models.TransientModel):
    _name = "care.sales.register.wizard"
    _description = "Sales Register Wizard"
    ...
    include_refunds = fields.Boolean(
        ...
        help="Include customer credit notes (refunds) in the export.",
    )
    ...
    def action_export_excel(self):
        ...
        filename = "sales_register_%s_to_%s.xlsx" % (self.date_from, self.date_to)
        self.write(
            {
        ...
        return {
            ...
            "url": "/web/content/?model=care.sales.register.wizard&id=%s&field=file_data&filename_field=file_name&download=true"
            % self.id,
            "target": "self",
        }
    ...
    def _build_xlsx_bytes(self):
        ...
        try:
            ...
            sheet = workbook.add_worksheet(_("Sales Register"))
