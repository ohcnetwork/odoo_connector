    ...
    def _collect_hsn_data(self, invoices):
        ...
        for invoice in invoices:
            ...
            for line in invoice.invoice_line_ids:
                ...
                # Get description (use product name, HSN description field may not exist)
                description = ''
                if line.product_id:
                    # Try to get HSN description from product template if available
                    if hasattr(line.product_id, 'l10n_in_hsn_description') and line.product_id.l10n_in_hsn_description:
                        description = line.product_id.l10n_in_hsn_description
                        ...
                        description = line.product_id.product_tmpl_id.l10n_in_hsn_description
                    else:
